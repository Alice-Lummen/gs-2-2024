    ...
    <main className="relative w-full">
      ...
      <div className="flex flex-col w-full h-[95vh] mb-10 overflow-hidden items-center" style={{ backgroundColor: "var(--verde-escuro)" }}>
        ...
        {carregador ? (
          <>
            <div
              className="fixed top-32 left-10 w-24 md:w-24 h-20 md:h-28 p-3 flex items-center justify-center rounded-full animate-float bg-green-800 transition-opacity duration-500 opacity-100 hover:opacity-30"
              onClick={abrirModal}
            >
